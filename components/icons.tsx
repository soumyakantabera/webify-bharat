...
export function IconCheck({ size = 16, ...props }: IconProps) {
  return <Check size={size} strokeWidth={2.6} aria-hidden {...props} />;
}

export function IconBolt({ size = 16, ...props }: IconProps) {
  return <Zap size={size} strokeWidth={2.4} aria-hidden {...props} />;
}

export function IconTrend({ size = 16, ...props }: IconProps) {
  return <TrendingUp size={size} strokeWidth={2.4} aria-hidden {...props} />;
}
...
export function IconArrow({ size = 16, ...props }: IconProps) {
  return <ArrowRight size={size} strokeWidth={2.4} aria-hidden {...props} />;
}
